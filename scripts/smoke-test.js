...
module.exports = async function (callback) {
    try {
        ...
        const usdToken               = await MockUSDToken.deployed();
        ...
        console.log(`MockUSDC: ${usdToken.address}`);
        ...
        const USDC_AMOUNT = new BN(10000).mul(USD_UNIT); // 10,000 USDC
        await usdToken.getTokens(USDC_AMOUNT.toString(), buyer);
        ...
        const usdTokens                = [usdToken.address];
        ...
        console.log(`    • USD Token: ${usdToken.address} (${usdSymbol}, ${usdDecimals} decimals)`);
